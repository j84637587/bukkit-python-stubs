...
class NamespacedKey:
    @staticmethod
    def minecraft(name: str) -> 'NamespacedKey':
        ...
...
class ItemType:
    ...
    def getCraftingRemainingItem(self) -> Optional['Material']:
        ...
    
    def getDefaultAttributeModifiers(self, slot: 'EquipmentSlot') -> Dict[str, Any]:
        ...
...
class Material:
    ...
    def __init__(self, id: int, stack: int = 64, durability: int = 0, data: Optional[Type[MaterialData]] = None):
        self.id = id
        self.durability = durability
        self.maxStack = stack
        self.data = data
        self.legacy = self.name().startswith(self.LEGACY_PREFIX)
        self.key = NamespacedKey.minecraft(self.name().lower())
        self.itemType = ...
        self.blockType = ...
    ...
    def createBlockData(self, consumer: Optional[Callable[['BlockData'], None]]) -> 'BlockData':
        ...
    
    def createBlockData(self, data: Optional[str]) -> 'BlockData':
        ...
    ...
    def getMaterial(name: str, legacyName: bool = False) -> Optional['Material']:
        ...
    
    def matchMaterial(name: str, legacyName: bool = False) -> Optional['Material']:
        ...
    ...
    def getCreativeCategory(self) -> Optional['CreativeCategory']:
        ...
    
    def getTranslationKey(self) -> str:
        ...
    
    def getBlockTranslationKey(self) -> Optional[str]:
        ...
    
    def getItemTranslationKey(self) -> Optional[str]:
        ...
    ...
    def asItemType(self) -> Optional[ItemType]:
        ...
    
    def asBlockType(self) -> Optional[BlockType]:
        ...