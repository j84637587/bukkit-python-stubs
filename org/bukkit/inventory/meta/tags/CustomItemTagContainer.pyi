...
class CustomItemTagContainer(Generic[T, Z]):
    """
    ...
    def set_custom_tag(self, key: NotNull[NamespacedKey], type: NotNull[ItemTagType[T, Z]], value: NotNull[Z]) -> None:
        """
    ...
    def has_custom_tag(self, key: NotNull[NamespacedKey], type: NotNull[ItemTagType[T, Z]]) -> bool:
        """
    ...
    def get_custom_tag(self, key: NotNull[NamespacedKey], type: NotNull[ItemTagType[T, Z]]) -> Nullable[Z]:
        """
    ...
    def remove_custom_tag(self, key: NotNull[NamespacedKey]) -> None:
        """
    ...
    def get_adapter_context(self) -> NotNull[ItemTagAdapterContext]:
        """
